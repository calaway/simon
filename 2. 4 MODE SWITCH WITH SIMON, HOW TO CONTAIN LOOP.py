...
# Define the modes
modes = ["SimonGame", "ControllerMode", "LightsMode", "SoundMode"]
current_mode = 0  # This will start the program in SimonGame mode
...
while True:
    ...
    if modes[current_mode] == "SimonGame":
        SimonGame()
    elif modes[current_mode] == "LightsMode":
        LightsMode()
    elif modes[current_mode] == "SoundMode":
        SoundMode()
    elif modes[current_mode] == "ControllerMode":
        ControllerMode()
